...
const FAQS = [
  {
    q: "Apa itu Mincle?",
    a: "Mincle adalah aplikasi untuk mencari dan bergabung dengan circle/komunitas kecil di sekitarmu untuk beraktivitas bareng — mulai dari olahraga (gowes, jogging, jalan santai), kulineran, ngopi, sampai explore alam.",
  },
  {

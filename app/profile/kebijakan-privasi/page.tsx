      ...
      <div className="bg-white rounded-2xl border p-4 space-y-6">
        ...
        <Section title="1. Data yang Kami Kumpulkan">
          <ul className="list-disc pl-4 space-y-1">
            ...
            <li>Data profil yang kamu isi: nama panggilan, tanggal lahir, jenis kelamin, kategori olahraga favorit, kota domisili, akun Instagram, dan foto profil (opsional).</li>
        ...
        <Section title="2. Bagaimana Kami Menggunakan Data">
          <ul className="list-disc pl-4 space-y-1">
            <li>Menyediakan dan menjalankan fitur inti: membuat/menemukan circle, join, dan berinteraksi dengan sesama pengguna.</li>
            <li>Menampilkan circle di sekitarmu berdasarkan kota yang kamu pilih.</li>
            <li>Menampilkan profil dasar kamu (nama panggilan, foto, kategori olahraga) kepada pengguna lain di dalam circle yang sama, sebagai bagian normal dari fitur sosial aplikasi.</li>
